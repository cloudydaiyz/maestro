...
/**
 * Synchronizes a troupe with its source uris for events and event types, then updates the
 ...
 */
export class TroupeSync extends BaseDbService {
    ...
    /**
     * Helper for {@link TroupeSync.discoverAndRefreshAudience}. Discovers
